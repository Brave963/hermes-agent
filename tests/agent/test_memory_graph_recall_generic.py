...
def test_query_rank_terms_prioritize_high_signal_terms_over_question_noise():
    terms = SearchIndexer._query_rank_terms("左灏 DSE 选修科目是什么？有没有 M1/M2？")
...
def test_snippet_uses_high_signal_term_not_first_low_signal_match():
    content = "这是一段低价值命中：是什么、有没有。真正答案：左灏 DSE 选修 Physics/物理、Economics/经济、ICT，未选 M1/M2。"
    snippet = SearchIndexer._format_search_snippet(content, "左灏 DSE 选修科目是什么？有没有 M1/M2？")
